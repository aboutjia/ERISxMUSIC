...
async def play(_, message: Message):
    ...
    lel = await message.reply("🔎 **𝐅𝐢𝐧𝐝𝐢𝐧𝐠 💫 𝐓𝐡𝐞 𝐒𝐨𝐧𝐠 ❤️ ❰ 𝙏𝙍𝙄𝙎𝙃𝘼 𝙓 𝙈𝙐𝙎𝙄𝘾 ❱...**")
    ...
    try:
        ...
        user.first_name = "TRISHAxMUSIC_BOT"
    usar = user
    wew = usar.id
    try:
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                try:
                    ...
                    await lel.edit(
                        "<b>𝐀𝐝𝐝 𝐌𝐞 😎 𝐀𝐬 𝐀𝐝𝐦𝐢𝐧 𝐎𝐟 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩 💫  𝐅𝐢𝐫𝐬𝐭 ❰ 𝙏𝙍𝙄𝙎𝙃𝘼 𝙓 𝙈𝙐𝙎𝙄𝘾 ❱</b>")
                    return
    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
               ...
               [
                        InlineKeyboardButton(
                            text="𝐀𝐝𝐝 𝐁𝐨𝐭 𝐭𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩",
                            url=f"https://t.me/TrishaXmusic_bot?startgroup=true")
